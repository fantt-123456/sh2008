            ...
            <div class="center-view">
                ...
                <ul class="my-order-tab">
                    <li>
                        ...
                        <span
                            ...
                            >99+</span
                        >
                        <div class="common-p" @click="login">电影订单</div>
                    </li>
                    <li>
                        <img
                            ...
                            alt=""
                        />
                        <div class="common-p" @click="login">商品订单</div>
                    </li>
                </ul>
                <!---->
                <div class="margin-set my-card">
                    <img
                        ...
                        alt=""
                    />
                    <span class="label" @click="login">卖座券</span>
                    <img
                ...
                <div class="margin-set my-card">
                    <img
                        ...
                        alt=""
                    />
                    <span class="label" @click="login">组合红包</span>
                    <img
                        src="data:image/png;base64,"
                        alt=""
                        class="arrow"
                ...
                <div class="margin-set my-balance">
                    <img
                        ...
                        alt=""
                    />
                    <span class="label" @click="login">余额</span>
                    <span class="value"
                ...
                <div class="margin-set system-set">
                    <img
                        ...
                        alt=""
                    />
                    <span class="label" @click="login">设置</span>
                    <img
                        src="data:image/png;base64,"
                        alt=""
                        class="arrow"
